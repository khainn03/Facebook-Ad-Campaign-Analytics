...
3. [Code Structure](#code-structure)
   - [Step 1: Examine the Dataset](#step-1-examine-the-dataset)
   - [Step 2: Campaign Highlights](#step-2-campaign-highlights)
   - [Step 3: Ad Set Overview](#step-3-ad-set-overview)
   - [Step 4: Detailed Ad Set Analysis](#step-4-detailed-ad-set-analysis)
